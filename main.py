...
t = 65.8
c = 49.3
sum = 10+60+43+63+63+120+72+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78
print("总销售额：",253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+253.6*140+86.3*90+p*24+t*45+f*25+n*60+t*129+y*10+f*43+t*63+n*60+p*63+f*60+t*58+n*140+t*48+f*43+p*57+y*10+t*63+f*78)
print("平均每日销售数量：",sum/30)
y = 10+69+140+10+10
n = 60+72+35+90+60+60+140
f = 43+25+43+60+43+78
p = 63+24+63+57
t = 63+45+129+63+58+48+63
c = 120
print('羽绒服月销量占比：{:.2%}'.format(y/sum))
print('牛仔裤月销量占比：{:.2%}'.format(n/sum))
print('风衣月销量占比：{:.2%}'.format(f/sum))
print('皮草月销量占比：{:.2%}'.format(p/sum))
print('T恤月销量占比：{:.2%}'.format(t/sum))
print('衬衫月销量占比：{:.2%}'.format(c/sum))